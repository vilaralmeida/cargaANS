...
Sprint | Escopo | Prazo
--- | --- | ---
1 | Provisionamento de Ambientes (Staging Area, Homologação) + Ambiente pré-produção + Modelagem de Dados | 28/Dez/18
2 | Carga direta dos Dados no Ambiente de Homologação | 18/Jan/19
